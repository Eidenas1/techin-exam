  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-semibold mb-6">Are you sure you want to delete this Book?</h2>
        <div className="flex justify-center gap-16">
            <button onClick={onConfirm} className=" rounded-2xl border-2 h-2/16 w-3/16 text-[1.75rem] justify-center max-xl:text-[1.25rem] max-xl:h-3/16">
              Yes
            </button>
            <button onClick={onClose} className=" rounded-2xl border-2 h-2/16 w-3/16 text-[1.75rem] justify-center max-xl:text-[1.25rem] max-xl:h-3/16">
               No
            </button>
        </div>
      </div>
