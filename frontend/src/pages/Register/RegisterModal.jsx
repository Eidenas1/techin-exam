        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-4 justify-center justify-self-start self-start w-full h-1/2 border-white border-r-4 border-b-4">
              <h1 className="text-white text-4xl text-center">Sign Up</h1>
            </div>
            <form
            ...
            >
              ...
              <pre className="text-2xl text-white font-light max-xl:text-xl">
                {errorMessage}
              </pre>
              <input
              ...
              <input
                type="submit"
                value="Register"
                className=" bg-white rounded-2xl border-2 h-3/16/16 w-4/16 text-[1.75rem] justify-center max-xl:text-[1.25rem] max-xl:h-3/16"
              />
            </form>
          </div>
        </div>
